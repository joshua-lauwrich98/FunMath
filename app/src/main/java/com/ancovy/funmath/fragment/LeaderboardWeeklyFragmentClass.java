...
public class LeaderboardWeeklyFragmentClass extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_leaderboard_weekly_class_chal, container, false);

        RecyclerView rv = (RecyclerView)view.findViewById(R.id.recycler_view_leaderboard_weekly_chal);
