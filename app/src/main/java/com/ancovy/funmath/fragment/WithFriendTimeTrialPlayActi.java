...
public class WithFriendTimeTrialPlayActi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
                getFragmentManager().beginTransaction().replace(R.id.play_activity_container, new WithFriendTimeTrialPlayActiDefaultTempFragment()).commit();
            }
        }.start();
